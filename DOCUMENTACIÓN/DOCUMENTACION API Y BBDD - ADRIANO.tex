...
\justify
Si se desea comprobar la ejecución del workflow, se recomienda ver el video que se encuentra en el directorio \textbf{videos} ubicado en la raíz del proyecto.
